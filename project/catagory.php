...
<marquee><h1>Welcome to the Library</h1></marquee>
        <div class="row justify-content-center">
            <div class="col-md-6 form-container">
                <h1 class="text-center py-3">Add New Catagory</h1>
                <form action="catagory_action.php" method="POST">
                    <div class="my-2">
                        <label for="studentName" class="form-label">Catagory Name :</label>
                        <input type="text" name="catagory" class="form-control" id="catagory" placeholder="Enter Catagory Name"  required>
                    </div>
...
<?php
if(isset($_SESSION["catagory"]) && $_SESSION["catagory"] == "catagory"){
  echo "<script> alert('catagory already exists');   </script>";
  $_SESSION["catagory"] = "";
}
if(isset($_SESSION["add_catagory"]) && $_SESSION["add_catagory"] == "add_catagory"){
  echo "<script> alert('Add Success');   </script>";
  $_SESSION["add_catagory"] = "";
}
?>
</body>
</html>
