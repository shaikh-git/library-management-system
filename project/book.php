  ...
  <div class="container">
    <marquee><h1>Welcome to the Library</h1></marquee>
        <div class="row justify-content-center">
            <div class="col-md-6 form-container  py-3">
                ...
                <form action="book_action.php" method="POST">
                    ...
                    <div class="my-2">
                        ...
                        <input type="number" name="price" class="form-control" id="price" placeholder="Enter Book Price"  required>
                    </div>
                    <div class="my-2">
...
<?php
if(isset($_SESSION["add_book"]) && $_SESSION["add_book"] == "add_book"){
  echo "<script> alert('Book Add Success');   </script>";
  $_SESSION["add_book"] = "";
}
?>
</body>
