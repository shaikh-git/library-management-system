...
<div class="sidebar">
  ...
  <marquee><h1>Welcome to the Library</h1></marquee>
    <h2 class="text-center pb-4">All Registered Students Information</h2>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
  ...
  <?php
if(isset($_SESSION["student_delete"]) && $_SESSION["student_delete"] == "student_delete"){
  echo "<script> alert('Delete Success');   </script>";
  $_SESSION["student_delete"] = "";
}
if(isset($_SESSION["student_update"]) && $_SESSION["student_update"] == "student_update"){
