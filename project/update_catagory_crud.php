    ...
    <marquee><h1>Welcome to the Library</h1></marquee>
        <div class="row justify-content-center ">
            <div class="col-md-8 form-container ">
                <h1 class="text-center py-3">Update Catagory</h1>
                <form action="update_catagory_action.php" method="POST">
                <input type="hidden" name="id" class="form-control" id="id" value="<?php echo $row["id"]; ?>" >
                    <div class="my-2">
                        ...
                        <input type="text" name="catagory" class="form-control" id="catagory" placeholder="Enter Catagory Name" value="<?php echo $row["catagory"]; ?>"  required>
                    </div>


                    <button type="submit" class="btn btn-primary w-100 my-3">Update Now</button>
                </form>
