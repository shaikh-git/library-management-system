    ...
    <marquee><h1>Welcome to the Library</h1></marquee>
        <div class="row justify-content-center">
            <div class="col-md-8 form-container  py-3">
                ...
                <form action="not_returned_action.php" method="POST">
                    <div class="my-2">
...
<?php
if(isset($_SESSION["add_returned"]) && $_SESSION["add_returned"] == "add_returned"){
  echo "<script> alert('Add Returned Success');   </script>";
  $_SESSION["add_returned"] = "";
}
?>
</body>
</html>
