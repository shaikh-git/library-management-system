...
<body>
  ...
  <div class="content">
    ...
    <h2 class="text-center pb-4">All Catagorys</h2>
    <div class="table-responsive">
      <table class="table table-bordered table-striped" id="myTable">
        ...
        <tr>
            ...
            <td><a href="delete_catagory_crud.php?id=<?php echo $row["id"];   ?>">Delete</a></td>
            <td><a href="update_catagory_crud.php?id=<?php echo $row["id"];   ?>">Update</a></td>
        </tr>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
  ...
  <?php
if(isset($_SESSION["delete_catagory"]) && $_SESSION["delete_catagory"] == "delete_catagory"){
  echo "<script> alert('Delete Success');   </script>";
  $_SESSION["delete_catagory"] = "";
}
if(isset($_SESSION["update_catagory"]) && $_SESSION["update_catagory"] == "update_catagory"){
  echo "<script> alert('Update Success');   </script>";
  $_SESSION["update_catagory"] = "";
}
?>
</body>
</html>
