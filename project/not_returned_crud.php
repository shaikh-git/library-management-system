...
<body>
  ...
  <marquee><h1>Welcome to the Library</h1></marquee>
    <h2 class="text-center pb-4">All Not Returned Books Information</h2>
    <div class="table-responsive">
      <table class="table table-bordered table-striped" id="myTable">
        ...
        <?php
        $sql = "select returned.expiry_date, returned.id as ret_id, returned.status, users.id as student_id, users.full_name, users.email, book.name as book_name from `returned` inner join `users` on returned.student_id = users.id inner join `book` on returned.book_id = book.id ";
        ...
        <tr>
            ...
            <td><a href="delete_not_returned.php?id=<?php echo $row["ret_id"];   ?>">Delete</a></td>
            <td><a href="update_not_returned.php?id=<?php echo $row["ret_id"];   ?>">Update</a></td>
        </tr>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/js/bootstrap.bundle.min.js"></script>
  ...
  <?php
if(isset($_SESSION["delete_returned"]) && $_SESSION["delete_returned"] == "delete_returned"){
  echo "<script> alert('Delete Success');   </script>";
  $_SESSION["delete_returned"] = "";
}
if(isset($_SESSION["update_returned"]) && $_SESSION["update_returned"] == "update_returned"){
  echo "<script> alert('Update Success');   </script>";
  $_SESSION["update_returned"] = "";
}
?>
</body>
</html>
